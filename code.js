...
figma.ui.onmessage = (msg) => __awaiter(void 0, void 0, void 0, function* () {
    if (msg.type === 'create-columns') {
        ...
        const value = yield removeWeirdChars(elem.characters);
        ...
        const textArray = matches.map((match, i) => {
        ...
        function createTextbox() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (let i = 0; i < textArray.length; i++) {
                    ...
                    textbox.fills = elem.fills.map(fill => (Object.assign(Object.assign({}, fill), { blendMode: elem.fills[0].type === 'SOLID' ? fill.blendMode : undefined })));
                    if (elem.fontName !== figma.mixed) {
                        yield figma.loadFontAsync({ family: elem.fontName.family, style: elem.fontName.style });
                        textbox.fontName = {
